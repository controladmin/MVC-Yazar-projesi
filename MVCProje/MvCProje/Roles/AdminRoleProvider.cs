...
using System.Linq;
using System.Web;
using System.Web.Security; // RoleProvider sınıfını kullanabilmek için ekledik
...
namespace MvCProje.Roles
{
    public class AdminRoleProvider : RoleProvider
    {
        ...
        public override string[] GetRolesForUser(string username)
        {
            ...
            var adminresult = c.Admins.FirstOrDefault(y => y.AdminUserName == username);
            var resultWriter = c.Writers.FirstOrDefault(x => x.WriterMail == username);
            if(adminresult!=null)
            {
                return new string[] { adminresult.Role.RoleName };
            }
